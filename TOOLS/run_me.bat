...
start DUMLdoreV3.exe
echo please load the file "custom_306_super_patcher_MavicPro_MPP_dji_system.bin" into DUMLdore and click "flash firmware"  
...
ECHO and then connect to Assistant 2 and use the simulator to ensure proper working order in the sim before testing outside 
pause 
Echo You may now modify any paramters you'd like using Assistant 2 1.1.2 in debug mode
Pause
Echo You have completed the patching operation. Please note all settings on the Mavic are likely now reset
Echo remember to redo your RTH altitude and such.
Pause 
