...
Echo 		(No change in yaw speed untill set by user in Assitant 1.1.2,
Echo			 normal mode yaw speed can be set in DJI Go 4)
ECHO *********************************************************************************  
ECHO To undo this modification, simply reflash stock 01.04.0300 using DUMLdore
...
ECHO **********************************************************************************
ECHO **The purpose of this modification is to allow experienced and law abiding citizens to unlock their Mavic Pro 
ECHO without the need to contact DJI to fly their aircraft.
Echo ****Use at your own risk***
Pause
ECHO *********************************************************************************
Echo The pilot in command is always resposible for flight safety and following local regulations. 
Echo This removes some of the "idiot-proofing" designed into DJI products so 
Echo take extra care to know your local laws before each flight**
